...
fmri_data = masker.transform(fmri_img).T
...
>>>>>>> 2a57fdc... Playing with examples
                              axis=-1)
p_values = mask.inverse_transform(p_values).get_data()
...
plot_stat_map(nibabel.Nifti1Image(log_p_values, fmri_img.get_affine()), mean_img,              title="p-values", cut_coords=cut_coords, axes=fig_id)
